javascript:(function() {
	function trgr() {
			...
			my_html += '<span style="float:left;""<strong>Information</strong></span>';
			...
			var ta_content = '検査ページ数 ' + cnt;
			document.getElementById("reportArea").textContent = ta_content;
			if(document.getElementById("hdjs") == null) {
				var hdjs = document.createElement('script');
				hdjs.id = 'hdjs';
				hdjs.type = 'text/javascript';
				var hdjs_str = '';
				hdjs_str += 'var e = document.getElementById("Info_diag");';
				hdjs_str += 'var flag;';
			...
			if(document.getElementById("mycss") == null) {
				...
				mycss_str += 'z-index:2999;width:360px;height:200px;';
				mycss_str += '}';
				mycss_str += '#reportArea {font-family:"メイリオ",sans-serif;font-size:90%; font-size:100%; boder:1px solid #ccc; width: 360px; height: 200px; overflow: scroll;}';
