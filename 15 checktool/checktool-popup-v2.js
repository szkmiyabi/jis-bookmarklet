javascript:(function() {
	...
	function trgr(guidelines, surveyarr) {
		...
		if(document.getElementById("mycss") == null) {
			...
			mycss_str += 'z-index:2999;width:590px;height:250px;';
			mycss_str += '}';
			mycss_str += '#CheckTool_diag button { font-size: 100%; }';
			mycss_str += '#reportArea { boder:1px solid #ccc; width: 590px; height: 200px; overflow: scroll;}';
			mycss_str += '#reportTable { width: 590px; border-collapse:collapse; }';
