javascript:(function(){
	...
	var p1 = new RegExp(/(<span class="help_text">)(.+?)(<\/span>)/g);
    var p2 = new RegExp(/(<p><span class="help_text">)(.+?)(<\/span><\/p>)/g);
	var desc = util.text_clean(util.get_description());
	var src = util.text_clean(util.get_srccode());
	desc = desc.replace(p1, "");
	src = src.replace(p2, "");
	util.set_description(desc);
	util.set_srccode(src);
